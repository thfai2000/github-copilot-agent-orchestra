...
# ─── Deploy infrastructure (Redis + namespace) ──────────────────────────────

echo ""
echo "▸ [1/2] Deploying infrastructure (Redis + namespace) ..."
helm upgrade --install infrastructure "${HELM_DIR}/infrastructure" \
...
echo ""
echo "▸ [2/2] Deploying Agent Orchestration Platform ..."
...
echo "    agent-platform      — Agent API + UI"
echo ""
